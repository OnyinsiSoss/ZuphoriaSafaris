...
export const NewLetter = () => {
  return (
    <section className=" " >
      <div style={{ height:"100%", background:'linear-gradient(180deg, rgba(0, 0, 0, .7),rgba(0, 0, 0, .7))'}}  className="lg:my-30 lg:mx-60 md:mx-40 sm:m-10 m-10 px-5 py-20 rounded-xl sm:p-10 relative lg:py-40 md:py-20 overflow-hidden">
      <Image
            src="/images/Pic-90.JPG"
            alt="Member"
            fill
            sizes="100vw"
      ...
      <div className=" m-auto">
        <div className="flex items-center flex-col gap-7">
          ...
          <p className=" sm:text-2xl text-stone-100 text-center">
            Subscribe to our newsletter and Access our &quot; How we work &quot; guide !! 
            {/* Enquire now and one of our travel designers will be in touch with you shortly */}
          </p>
            
          <div className="flex lg:flex-row flex-col w-fit gap-5 sm:items-center ">
            <input 
