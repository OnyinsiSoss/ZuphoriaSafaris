  ...
  return (
    <Section className=" px-16">
      <Container className="m-auto">
        ...
        <div>
          <div className="mb-12 sm:mb-14 pb-4">
            <Heading as="h2" className="text-emerald-900 text-5xl leading-none">
              Let us build your dream vacation
            </Heading>
          </div>
          <div className="flex flex-col justify-center  lg:flex-row gap-10 m-auto ">
            <div style={{height:"600px", overflow:"hidden", background: 'linear-gradient(180deg, rgba(0, 0, 0, .7), rgba(0, 0, 0, .3))'}} className="flex group relative rounded-xl overflow-hidden   ">
              <Image
            ...
            <div style={{height:"600px", background: 'linear-gradient(180deg, rgba(0, 0, 0, .7), rgba(0, 0, 0, .3))'}} className="flex group relative rounded-xl  overflow-hidden ">
              <Image 
                src="/images/Pic-10.JPG"
                alt="Member"
                width={320} 
