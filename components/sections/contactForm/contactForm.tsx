...
export const ContactForm = () => {
  return (
    <section className='flex items-center w-full m-auto box-border '>
        <Container className='flex flex-col bg-white items-center rounded-xl m-auto lg:m-40 shadow-xl/40 w-screen'>
            <div className=' sm:w-1/2 flex justify-center items-center'>
              <form className='p-20 flex items-center flex-col gap-20 rounded-4xl'>
                <Heading as="h1" className="flex text-4xl text-center text-emerald-900 ">
