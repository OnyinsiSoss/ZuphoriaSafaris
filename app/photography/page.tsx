       ...
       >
        ...
        <Section className="">
          <Container className=" text-center text-white">
            <SubTitle
              subTitle="Highlights of our Photography Safari drive"
            ...
            <div className="grid md:grid-rows justify-items-center gap-4 sticky">
              ...
              <div
                ...
                className="grid gap-5 py-12 relative p-4 rounded-xl"
              >
                <div>
      ...
      <Section className="bg-slate-300 flex flex-col lg:flex-row gap-10 w-full p-8 md:p-32 ">
        ...
        <div className="flex justify-center items-center">
          <p className="text-slate-800 text-center text-2xl  ">
            Remember, wildlife conservation and ethical practices should always
            be a priority during a photography safari drive. Respect the
            animals, adhere to park regulations, and avoid disrupting their
            natural behavior or habitats. Additionally, be mindful of your
            impact on the environment and follow responsible photography
